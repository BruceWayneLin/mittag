  ...
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <div class="form-group required">
        ...
        <input type="text" name="firstname" value="" placeholder="姓名" id="input-payment-firstname" class="form-control" />
      </div>
      ...
      <div class="form-group required">
        ...
        <input id="mobileNumb" type="text" name="telephone" value="" placeholder="<?php echo $entry_telephone; ?>" id="input-payment-telephone" class="form-control" />
        <span style="color:red;">*請注意，您輸入的電話將成為您的帳號密碼</span>
      </div>
    ...
    <fieldset class="hidden">
      ...
      <div class="form-group required">
        ...
        <input id="password" type="password" name="password" value="" placeholder="<?php echo $entry_password; ?>" id="input-payment-password" class="form-control" />
      </div>
      <div class="form-group required">
        <label class="control-label" for="input-payment-confirm"><?php echo $entry_confirm; ?></label>
        <input id="password2" type="password" name="confirm" value="" placeholder="<?php echo $entry_confirm; ?>" id="input-payment-confirm" class="form-control" />
      </div>
    </fieldset>
  </div>
  <div class="col-sm-6">
    <fieldset id="address">
      ...
      <div class="form-group hidden">
        ...
        <input type="hidden" name="city" value="" placeholder="<?php echo $entry_city; ?>" id="input-payment-city" class="form-control" />
      </div>
      <div class="form-group hidden">
